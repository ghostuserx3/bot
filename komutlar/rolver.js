...
exports.run = async (bot, message, args) => {
    if (!message.member.hasPermission("CONNECT")) return message.channel.sendEmbed(new Discord.RichEmbed().setDescription('Bu komutu kullanmak için **Rolleri Yönet** yetkisine sahip olmalısın.').setColor(10038562));
